...
// Load model
// (`then` triggers after model is loaded, sets local variable `model` to loaded model)
tf.loadLayersModel('models/model.json').then(e => model=e);

// Process new image
reader.onload = function (e) {
	// Update the image displayed to the user in the browser
	...
	// (basically puts the image in an array, I assume because 
	// you can only predict on a set of data points, not on a 
	// single image by itself)
